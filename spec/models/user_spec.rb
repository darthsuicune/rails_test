...
describe User do
  ...
  describe "with admin attribute activated" do
    before do
      @user.save!
      @user.toggle!(:admin)
    end
  ...
  describe "when name is waaaay too long" do
  ...
  describe "when password isn't matching confirmation" do
  ...
  describe "microposts" do
    ...
    it "should destroy related microposts" do
    ...
    describe "status" do
      ...
      before do
        ...
        3.times { followed_user.microposts.create!(content: "Random text") }
      end
